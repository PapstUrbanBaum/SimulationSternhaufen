...
def main():
    ...
    plt.title('Verteilung der kinetischen Energie (Zeit: {} Jahre)'.format(time_step))
    plt.xlabel('Logarithmus der kinetischen Energie in 4.47 * 10³⁷J')
    plt.ylabel('Anzahl der Körper')
    plt.savefig('../Diagramme/Auswertung/Ekin/Ekinverteilung_{}k{}.png'.format(num_bodies, time_step))
    plt.close()
